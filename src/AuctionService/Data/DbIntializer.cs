...
namespace AuctionService.Data
{
    public class DbIntializer
    {
        ...
        {
            /*The using keyword is used to allow the framework to dispose any services that comes
            in this line of code when it is no longer being used*/
            using var scope = app.Services.CreateScope();
            Console.WriteLine("This get executed once");
        ...
        public static void SeedData(AuctionDbContext context)
        {
            ...
            /*Check if database has a data already*/
            if (context.Auctions.Any())
            {
                Console.WriteLine("Database has data already");
                return;
            }

            Console.WriteLine("This gets executed Twice");
            /*Create auctions data*/
